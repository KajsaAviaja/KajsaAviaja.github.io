...
function CodeBlock({
  ...
  return (
    <div className="relative overflow-hidden rounded-lg bg-stone-900/5 dark:bg-white/5">
      <button
        type="button"
        onClick={handleCopy}
        className="absolute top-2 right-2 rounded-md border border-stone-900/10 bg-stone-50/80 px-2 py-1 text-xs text-stone-500 transition-colors hover:border-amber-700/40 hover:text-amber-700 dark:border-white/10 dark:bg-slate-900/80 dark:text-stone-400 dark:hover:border-amber-200/40 dark:hover:text-amber-200"
      >
